...
export function parseExcelFileServer(buffer: Buffer): ParseResult {
  try {
    console.log('🔍 Parseando Excel en servidor...');
    
    // En el servidor, leemos directamente el Buffer
    ...
    console.error('❌ Error en parseo servidor:', error);
    return {
      data: [],
