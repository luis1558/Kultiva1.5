...
const obtenerDimensionId = (dimension: string): number | null => {
  const dimensiones: Record<string, number> = {
    ...
    "Seguridad y estabilidad": 8, // ID correspondiente para Seguridad y estabilidad
    "Comunicación": 5,
...
export default function SeguridadYEstabilidad() {
  ...
  const dimension = "Seguridad y estabilidad"; // Dimensión deseada
