...
const obtenerDimensionId = (dimension: string): number | null => {
  const dimensiones: Record<string, number> = {
    ...
    "Ética e integridad": 7, // ID correspondiente para Ética e integridad
...
export default function EticaEIntegridad() {
  ...
  const dimension = "Ética e integridad"; // Dimensión deseada
