...
export default function CulturaOrganizacional() {
  ...
  const [guardado, setGuardado] = useState<boolean>(false); // Estado para controlar el guardado

  const dimension = "Cultura organizacional"; // Definir la dimensión "Cultura organizacional"
