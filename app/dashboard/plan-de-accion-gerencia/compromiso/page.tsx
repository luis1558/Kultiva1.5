...
export default function Compromiso() {
  ...
  const [guardado, setGuardado] = useState<boolean>(false); // Nuevo estado para controlar el guardado

  const dimension = "Compromiso"; // Cambia este valor según la dimensión deseada
...
<p>
        ...
        puedes copiar y pegar en los recuadros inferiores. Además, si lo
