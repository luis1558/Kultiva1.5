...
export default function Encuestas() {
  ...
  const [user, setUser] = useState<{ id: string; jefe_id: string } | null>(
    null
  );
  ...
  return (
    <>
      <div className="flex justify-center mt-12 min-w-96">
        <div className="max-w-5xl text-center px-4">
          ...
          <div className="text-center">
            ...
            <p>
              <br />
              Si deseas reportar un error sobre la
              encuesta o tienes alguna duda, comunícate con: Ejemplo - ejemplo@ejenmplo.com
            </p>
          </div>
          <p className="mt-8 ">¡Agradecemos tu participación!</p>
        </div>
      </div>
