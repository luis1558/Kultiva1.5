...
export async function POST(req) {
  try {
    console.log("Inicio del endpoint POST /api/correos");
    ...
    const mailOptions = {
      ...
      subject: "Plan de acción: encuesta de clima organizacional",
      text: `
Hola, líder.

Hemos recibido exitosamente tu plan de acción. 

Adjunto encontrarás un excel con las acciones de mejora que seleccionaste para las dimensiones donde obtuviste un resultado inferior al 75% en la encuesta de Clima Organizacional. Te recordamos la importancia de dar seguimiento al cumplimiento de cada una de estas acciones y de mantener una comunicación abierta con tu equipo para fomentar la retroalimentación y lograr una mejora continua.
