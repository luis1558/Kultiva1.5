...
// api para obtener las sugerencias de la gerencia
export async function GET(req) {
    try {
        // obtener la dimension de la query string
        ...
        // Consulta para obtener las sugerencias de la dimension especifica
        const query = `
            SELECT
                sugerencia_1,
                sugerencia_2,
